...
/**
 * Common icon set (owner: UI-DS / UI-0). Feature-specific sets live next to it as
 * `sets/<owner>.ts`; `pnpm gen` merges every set into `components/icons/index.ts` (generated).
 * Keys must be unique across sets — the generator fails on duplicates.
 */
export const icons = {
  // General
